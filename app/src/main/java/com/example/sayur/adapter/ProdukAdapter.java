...
public class ProdukAdapter extends RecyclerView.Adapter<ProdukAdapter.ListViewHolder> {
    ...
    public ProdukAdapter(List<Produk_model> produk) {
        this.produk = produk;
    }
    ...
    @Override
        ...
        final Produk_model model=produk.get(position);
        ...
        if (model.getStok()==0){
            ...
            holder.cardProduk.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), DetailProduk.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
