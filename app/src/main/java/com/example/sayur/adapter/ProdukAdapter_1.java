...
public class ProdukAdapter_1 extends RecyclerView.Adapter<ProdukAdapter_1.ListViewHolder> {
    private List<Produk_model_1>produk;
    private Context context;
    private int jml = 1;

    public ProdukAdapter_1(List<Produk_model_1> produk) {
        this.produk = produk;
    }
    ...
    @Override
        ...
        final Produk_model_1 model=produk.get(position);
